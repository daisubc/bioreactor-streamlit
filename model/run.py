...
def k_D(res, param):
  ...
  kD = 0.1
  if res['Glc'] > 0:
    kD = 0.05*(1-param['Kl2_Amm']/(param['Kl2_Amm']+res['Amm'])) + \
        0.05*(1-param['Kl2_Lac']/(param['Kl2_Lac']+res['Lac']))
  return kD
...
def PPR(res, param):
  ...
  """
  q_P = (param['alpha']*res['mu']+param['beta']) * \
      param['Kl3_Amm']/(param['Kl3_Amm']+res['Amm'])
  return q_P
